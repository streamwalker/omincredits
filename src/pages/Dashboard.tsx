    ...
    <div className="max-w-[1200px] mx-auto">
      ...
      <GlassCard className="p-0 overflow-hidden mb-8" hover={false}>
        <div className="flex flex-wrap">
          <div className="flex-1 min-w-[360px] p-9 space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {[1, 2, 3, 4].map(i => (
          <GlassCard key={i} hover={false} className="flex items-center gap-4 p-5">
      ...
      <GlassCard hover={false} className="p-0">
        {[1, 2, 3].map(i => (
          <div key={i} className="flex items-center justify-between px-6 py-4" style={{ borderBottom: i < 3 ? "1px solid hsl(var(--border))" : "none" }}>
